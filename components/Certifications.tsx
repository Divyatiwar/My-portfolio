...
const certificationsData = [
  {
    ...
    issuer: "Certificate of completion the complete 2024 Web Development Certificate",
  },
  {
...
export default function Certifications() {
  ...
  return (
    <section id="certifications" ref={ref} className="py-20 bg-gray-900/30 section-padding">
      <motion.div
